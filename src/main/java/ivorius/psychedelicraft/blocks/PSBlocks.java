...
public interface PSBlocks {
    ...
    Block FLASK = register("flask", new FlaskBlock(Settings.of(Material.GLASS).hardness(1)));
    Block DISTILLERY = register("distillery", new DistilleryBlock(Settings.of(Material.GLASS).hardness(1)));
    Block BOTTLE_RACK = register("bottle_rack", new BottleRackBlock(Settings.of(Material.WOOD).hardness(0.5F)));

    Block DRYING_TABLE = register("drying_table", new DryingTableBlock(Settings.of(Material.WOOD).hardness(2)));
    Block IRON_DRYING_TABLE = register("iron_drying_table", new DryingTableBlock(Settings.of(Material.METAL).hardness(5)));
