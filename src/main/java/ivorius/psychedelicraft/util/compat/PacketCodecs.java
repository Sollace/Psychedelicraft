...
public interface PacketCodecs {
    PacketCodec<ByteBuf, String> STRING = PacketCodec.ofStatic((buff, s) -> StringEncoding.encode(buff, s, PacketByteBuf.MAX_TEXT_LENGTH), buff -> StringEncoding.decode(buff, PacketByteBuf.MAX_TEXT_LENGTH));
    ...
    PacketCodec<PacketByteBuf, NbtElement> NBT_ELEMENT = PacketCodec.ofStatic(PacketByteBuf::writeNbt, PacketByteBuf::readNbt);
