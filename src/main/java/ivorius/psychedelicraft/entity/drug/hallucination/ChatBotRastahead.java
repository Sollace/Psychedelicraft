...
{
    private static final String[][] randomStatements = new String[][] {
    ...
    private static final String[][] responseMessagesPlayer = new String[][] {
            new String[]{"<Reggie> Haha, you're so right."},
            new String[]{"<Reggie> Haha, he's so right."},
            new String[]{"<Reggie> Yes."}
    };

    private static final String[][] responseMessagesOther = new String[][] {
        new String[]{"<Reggie> Haha, he's so right."}
    };
