...
public record DrugType<T extends Drug> (
    ...
    public static final DrugType<MorphineDrug> MORPHINE = register("morphine", MorphineDrug.FUNCTIONS, SimpleDrug::createCodec, type -> new MorphineDrug(type, 1, 0.0003d));
    public static final DrugType<MorphineDrug> METHAMPHETAMINE = register("methamphetamine", MorphineDrug.FUNCTIONS, SimpleDrug::createCodec, type -> new MorphineDrug(type, 1, 0.0003d));
