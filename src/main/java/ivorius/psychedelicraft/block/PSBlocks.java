...
public interface PSBlocks {
    ...
    Block JUNIPER_SIGN = register("juniper_sign", new SignBlock(Settings.of(Material.WOOD).noCollision().strength(1.0f).sounds(BlockSoundGroup.WOOD), PSWoodTypes.JUNIPER));
    Block JUNIPER_DOOR = register("juniper_door", new DoorBlock(Settings.of(Material.WOOD, JUNIPER_PLANKS.getDefaultMapColor()).strength(3.0f).sounds(BlockSoundGroup.WOOD).nonOpaque(), PSWoodTypes.JUNIPER.setType()));
    Block JUNIPER_WALL_SIGN = register("juniper_wall_sign", new WallSignBlock(Settings.of(Material.WOOD).noCollision().strength(1.0f).sounds(BlockSoundGroup.WOOD).dropsLike(JUNIPER_SIGN), PSWoodTypes.JUNIPER));
    Block JUNIPER_HANGING_SIGN = register("juniper_hanging_sign", new HangingSignBlock(AbstractBlock.Settings.of(Material.WOOD, JUNIPER_LOG.getDefaultMapColor()).noCollision().strength(1.0f).sounds(BlockSoundGroup.HANGING_SIGN).requires(FeatureFlags.UPDATE_1_20), PSWoodTypes.JUNIPER));
    Block JUNIPER_WALL_HANGING_SIGN = register("juniper_wall_hanging_sign", new WallHangingSignBlock(AbstractBlock.Settings.of(Material.WOOD, JUNIPER_LOG.getDefaultMapColor()).noCollision().strength(1.0f).sounds(BlockSoundGroup.HANGING_SIGN).requires(FeatureFlags.UPDATE_1_20).dropsLike(JUNIPER_HANGING_SIGN), PSWoodTypes.JUNIPER));
    Block JUNIPER_PRESSURE_PLATE = register("juniper_pressure_plate", new PressurePlateBlock(PressurePlateBlock.ActivationRule.EVERYTHING, Settings.of(Material.WOOD, JUNIPER_PLANKS.getDefaultMapColor()).noCollision().strength(0.5f).sounds(BlockSoundGroup.WOOD), PSWoodTypes.JUNIPER.setType()));
    ...
    Block JUNIPER_TRAPDOOR = register("juniper_trapdoor", new TrapdoorBlock(Settings.of(Material.WOOD, JUNIPER_PLANKS.getDefaultMapColor()).strength(3.0f).sounds(BlockSoundGroup.WOOD).nonOpaque().allowsSpawning(BlockConstructionUtils::never), PSWoodTypes.JUNIPER.setType()));
    Block JUNIPER_FENCE_GATE = register("juniper_fence_gate", new FenceGateBlock(Settings.of(Material.WOOD, JUNIPER_PLANKS.getDefaultMapColor()).strength(2, 3).sounds(BlockSoundGroup.WOOD), PSWoodTypes.JUNIPER));
