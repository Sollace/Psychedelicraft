...
public interface PSBlocks {
    ...
    Block JUNIPER_DOOR = register("juniper_door", new DoorBlock(Settings.of(Material.WOOD, JUNIPER_PLANKS.getDefaultMapColor()).strength(3.0f).sounds(BlockSoundGroup.WOOD).nonOpaque()));
    ...
    Block JUNIPER_PRESSURE_PLATE = register("juniper_pressure_plate", new PressurePlateBlock(PressurePlateBlock.ActivationRule.EVERYTHING, Settings.of(Material.WOOD, JUNIPER_PLANKS.getDefaultMapColor()).noCollision().strength(0.5f).sounds(BlockSoundGroup.WOOD)));
    ...
    Block JUNIPER_TRAPDOOR = register("juniper_trapdoor", new TrapdoorBlock(Settings.of(Material.WOOD, JUNIPER_PLANKS.getDefaultMapColor()).strength(3.0f).sounds(BlockSoundGroup.WOOD).nonOpaque().allowsSpawning(BlockConstructionUtils::never)));
    Block JUNIPER_FENCE_GATE = register("juniper_fence_gate", new FenceGateBlock(Settings.of(Material.WOOD, JUNIPER_PLANKS.getDefaultMapColor()).strength(2, 3).sounds(BlockSoundGroup.WOOD)));
    ...
    static <T extends Block> T register(String name, T block) {
        return Registry.register(Registry.BLOCK, Psychedelicraft.id(name), block);
    }
