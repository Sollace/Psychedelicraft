 ...
 */
public class WrapperDigitalMD extends ShaderWrapper<WrapperDigital.ShaderDigital> {
    ...
    public WrapperDigitalMD(String utils) {
        super(new WrapperDigital.ShaderDigital(Psychedelicraft.LOGGER), getRL("shaderBasic.vert"), getRL("shaderDigital.frag"), utils);
    }
